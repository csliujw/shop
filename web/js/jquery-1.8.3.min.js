...
(function (e, t) {
    ...
    v.event = {
        ...
        nt.matches = function (e, t) {
            ...
            K(function (e) {
                e.innerHTML = "<select><option selected=''></option></select>", e./*www.sucaijiayuan.com*/querySelectorAll("[selected]").length || i.push("\\[" + O + "*(?:checked|disabled|ismap|multiple|readonly|selected|value)"), e.querySelectorAll(":checked").length || i.push(":checked")
            }), K(function (e) {
