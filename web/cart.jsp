    ...
    <div class="cart w1200">
                ...
                <c:forEach items="${sessionScope.cart.cartItems}" var="item">
                    <ul class="item-content layui-clear">
                        <li class="th th-item" class="left: -50px;">
                            <div class="item-cont">
                                <img src="/${item.value.product.productImage}">
                                <div class="text">
                        ...
                        <li class="th th-op">
                            <a href="${pageContext.request.contextPath}/cart/remove.do?productName=${item.value.product.productName}"><span
        ...
        <div class="FloatBarHolder layui-clear">
            <div class="th Settlement">
                <a href="${pageContext.request.contextPath}/cart/addProduct.do?userId=${userInfo.userId}">
                    <button class="layui-btn" id="addProduct">结算</button>
                </a>
            </div>
            <div class="th total">
