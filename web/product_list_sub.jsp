...
<div class="row" style="width: 1210px; margin: 0 auto;">
    ...
    <input style="display: none" value="${products[0].subdivision.subdivisionId}" id="subdivisionId">
</div>
<!-- 引入footer.jsp -->
    ...
    layui.use(['form', 'layer'], function () {
        ...
        $("#more_product").click(function () {
            if ($subdivisionId == '') {
                ...
                let values = "page=" + page + "&limit=24&subdivision.subdivisionId=" + $subdivisionId;
                $.ajax({
